...
async def pause(client: Client, message: Message):
    ...
    await message.reply_text("**HELLBOTxADI:** ⏸ Paused.")
...
async def resume(client: Client, message: Message):
    ...
    await message.reply_text("**HELLBOTxADI:** ▶️ Resumed.")
...
async def stop(client: Client, message: Message):
    ...
    await message.reply_text("**HELLBOTxADI:** ⏹ Stopped.")
...
async def skip(client: Client, message: Message):
    ...
    await message.reply_text("**HELLBOTxADI:** ⏩ Skipped the current song.")
...
async def admincache(client, message: Message):
    ...
    await message.reply_text("**HELLBOTxADI:** ❇️ Admin cache refreshed!")
